<template>
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <s-stat-card :icon="CalendarCheck" bg-color="s-bg-icon-blue" icon-color="s-text-icon-blue" value="128" label="Total orders" />
...
<script setup>
import { CalendarCheck, Wallet, Hourglass, Star } from 'lucide-vue-next'
