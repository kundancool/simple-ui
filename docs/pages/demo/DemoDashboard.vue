<template>
    <div>
        ...
        <s-page-header title="Good evening, Kundan" subtitle="Here's what's happening across your properties today." />
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <s-stat-card :icon="BedDouble" bg-color="s-bg-icon-purple" icon-color="s-text-icon-purple" value="86%" label="Occupancy" />
        ...
        <s-card title="Latest bookings" class="mt-3">
...
<script setup>
import { Wallet, CalendarCheck, BedDouble, Hourglass } from 'lucide-vue-next'
...
const channels = ['Direct', 'MMT', 'Booking.com']
...
const rows = [
    ...
    { no: 'TMZ-104', guest: 'Meera Iyer', status: 'CONFIRMED', total: '₹3,350' },
]
</script>
