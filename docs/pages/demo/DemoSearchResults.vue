    ...
    <div>
        <DemoStage title="Live site search">
            <div class="max-w-2xl mx-auto">
                <s-filter v-model="query" placeholder="Search bookings, guests, invoices…" @search="noop" />
                ...
                <s-empty v-if="!results.length" title="No matches" description="Try “invoice”, “spa” or “204”." />
            </div>
        </DemoStage>
...
const { info } = useToast()
const index = [
    { id: 1, kind: 'Booking', tone: 'success', title: 'TMZ-101 · Aarav Sharma', snippet: 'Deluxe room · 12–14 Sep · ₹4,200' },
    { id: 2, kind: 'Invoice', tone: 'warning', title: 'INV-2026-0841 · ₹14,278 unpaid', snippet: 'Due 26 Sep · Aarav Sharma' },
    { id: 3, kind: 'Room', tone: 'info', title: 'Room 204 · Deluxe', snippet: 'Occupied till Sunday · late checkout approved' },
    { id: 4, kind: 'Service', tone: 'info', title: 'Spa voucher · ₹2,500', snippet: 'Wellness add-on · 40 in stock' },
    { id: 5, kind: 'Booking', tone: 'danger', title: 'TMZ-099 · Cancelled', snippet: 'Refunded ₹3,100 to virtual card' },
]
const query = ref('')
