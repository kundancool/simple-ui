 ...
 *
 * The full t-shirt scale: xs → 3xl. Every single-line form control resolves
 * `--s-field-h` from this map so a mixed row lines up by construction.
 * Never duplicate these literals in a component — import them.
 */
...
export const FIELD_SIZES: FormSize[] = ['xs', 'sm', 'md', 'lg', 'xl', '2xl', '3xl']
